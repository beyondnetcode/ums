...
| 31 | US-031 | EP-08 | FS-12 | Later Advanced IGA | As an IGA Administrator, I want to promote a role through a governed process so that role maturity evolves without uncontrolled changes. | Role governance becomes mature and controlled. | Promotion requestá captures current role, target state, reason, review, and approval. |
