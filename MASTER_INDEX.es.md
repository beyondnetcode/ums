# Indice Maestro -- Hub de Navegacion UMS

> **Idioma:** [English](./MASTER_INDEX.md) | [Espanol](./MASTER_INDEX.es.md)

Navegacion por fases de la documentacion del Sistema de Gestion de Usuarios (UMS).
...
- [Especificacion C4](./architecture/blueprints-es/architecture-spec.md)
...
- [Plan de Pruebas de Contrato](./architecture/artifacts-es/contract-testing-plan.md)
- [Estrategia de Observabilidad](./architecture/artifacts-es/observability-strategy.md)
