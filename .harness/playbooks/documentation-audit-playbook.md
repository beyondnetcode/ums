...
5. Stack references match the authoritative stack: `.NET 10`, `React 18`, `SQL Server`, `EF Core`, modular monolith.
6. Multi-tenancy is described with application-layer filtering as primary and SQL Server RLS as secondary failsafe.
