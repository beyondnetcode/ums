...
* **Status:** Accepted
* **Based on:** [arc32-27](https://github.com/beyondnetcode/arc32_progresive_monolith/blob/main/arc-corporate-ws/corporate-standards/02-adrs/nodejs/0027-dual-protocol-restá-grpc-api-gateway.md)
* **Date:** 2026-05-08

## Adaptation Summary

The corporate standard is adopted with the following project-specific modifications:
1. UMS uses .NET gRPC (Grpc.AspNetCore) instead of NestJS @nestájs/microservices gRPC transport.
