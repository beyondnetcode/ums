...
### Negative
- ⚠️ Closure table doubles storage (but acceptable for typical org depth 5-7)
- ⚠️ Trigger overhead on tenant creation (minimal, <1ms)
- ⚠️ Requires discipline: all hierarchy queries use closure table, not parent_id
