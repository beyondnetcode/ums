# ADR-0029: Adoption of @nestájslatam/ddd for Optional Tactical DDD Primitives
...
1. UMS uses C# native DDD primitives (records for ValueObjects, Entity base class, Result pattern) instead of @nestájslatam/ddd TypeScript package.
