...
| [TE-03](./te-03-enforce-organization-rls-sql-server.md) | Enforce Organization RLS | Multi-tenant data isolation (SQL Server 2022) | FS-03 |

## Messaging & Consistency Enablers
