...
[PENDING_MANAGER_APPROVAL]
  │
  ├─ APPROVED → [PENDING_SECURITY_REVIEW]
  │              │
  │              ├─ HIGH_RISK → [PENDING_SECURITY_APPROVAL]
  │              │               │
  │              │               ├─ APPROVED → [APPROVED_READY_TO_EXECUTE]
  │              │               │
  │              │               └─ REJECTED → [REJECTED]
  │              │
  │              └─ LOW_RISK → [APPROVED_READY_TO_EXECUTE]
  │
  └─ REJECTED → [REJECTED]
              │
              ▼
