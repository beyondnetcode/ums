...
|---|---:|---|
| Implemented / usable | 12 | FS-01, FS-02, FS-03, FS-04, FS-05, FS-07, FS-08, FS-18, FS-21, FS-22, FS-26, FS-27 |
| Partial | 14 | FS-09, FS-10, FS-11, FS-12, FS-13, FS-14, FS-15, FS-16, FS-17, FS-19, FS-20, FS-23, FS-24, FS-25 |
| Deferred | 1 | FS-06 |
...
|---|---|---|---|---|---|---|---|---|---|---|
| FS-10 | B2B External Access Request and Approval Flow | Amber | P1 | H | H | Approvals | TBD | Open | The external access flow still needs the `PROFILE_INTERNAL_ONLY` guard and a fully closed request-to-approval lifecycle. | Finish the validation rules and approval traceability for external onboarding. |
