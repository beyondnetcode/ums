...
- **KR 2.3**: Lograr una **sobrecarga de RLS en el ORM de < 5ms** por ejecución de consulta SQL.
...
- **KR 4.1**: Entregar un **Motor de Respaldo Nativo** funcional tanto para Identidad (bcrypt/DB interna) como para Feature Flags (evaluador/PostgreSQL) de fábrica, sin requerir dependencias SaaS externas.
