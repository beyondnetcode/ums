# Análisis de Costo/Beneficio — MVP Reducido UMS

**Fecha:** 2026-05-14  
**Versión:** 1.0  
**Propósito:** Análisis ejecutivo de costos y beneficios para MVP 12-semanas  
**Audiencia:** Stakeholders, Finance, C-level  
...
- GitHub Enterprise (on-prem or cloud) | S/ 3,600/3 meses
...
- Network/security patches | S/ 1,000

**SUBTOTAL INFRAESTRUCTURA (ON-PREM)** | **S/ 23,100**
...
- Monitoring (Application Insights, Log Analytics) | S/ 250/mes × 3 = S/ 750
...
- Security compliance (Azure Policy, built-in) | S/ 0

**SUBTOTAL INFRAESTRUCTURA (HÍBRIDO)** | **S/ 12,450**
...
- Monitoring & Analytics (premium) | S/ 500/mes × 3 = S/ 1,500
...
- Security scanning, compliance (built-in) | S/ 0

**SUBTOTAL INFRAESTRUCTURA (CLOUD-NATIVE)** | **S/ 21,300**
...
- Infrastructure efficiency (consolidación de sistemas) = S/ 120,000/año
...
| **Lock-in Risk** | Bajo | Medio | **Alto** ⚠️ |
...
1. **Costo Óptimo:** S/ 182,350 (11% menos que on-prem, 5% menos que cloud-native)
...
- On-prem si constrainted by compliance/data residency

**Si timeline se extiende (risk RLS/PDP):**
...
**Fecha:** 2026-05-14  
**Estado:** ✅ **ANÁLISIS COMPLETO - LISTO PARA JUNTA GOVERNANCE**
