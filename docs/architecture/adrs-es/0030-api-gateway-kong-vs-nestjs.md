# ADR 0030: Implementación de API Gateway: Kong Open Source vs NestJS

* **Estado:** Aceptado (Incorporado por Referencia)
* **Fuente Corporativa:** [arc32-30](https://github.com/beyondnetcode/arc32_progresive_monolith/blob/main/arc-corporate-ws/corporate-standards/02-adrs/0030-api-gateway-kong-vs-nstjs.md)
