# CP-06: PII-Safe Structured Logging with Serilog**Type:**Canonical Pattern**Status:**Accepted**Evolith disposition:**Proposed for Evolith — no product-specific dependencies; portable to any Serilog + ASP.NET Core satellite**Related ADR:** [ADR-0062: PII-Safe Serilog Configuration](../../adrs/0062-pii-safe-serilog-configuration.md)
