# CP-08: AOP Logging Decorator with Observability Envelope**Type:**Canonical Pattern**Status:**Accepted**Evolith disposition:**Proposed for Evolith — depends only on `BeyondNetCode.Shell.Logger.Serilog` (portable shell library)
**Related ADRs:**
