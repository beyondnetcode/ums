# CP-07: Idempotency Key Middleware**Type:**Canonical Pattern**Status:**Accepted**Evolith disposition:**Proposed for Evolith — no product-specific dependencies; portable to any ASP.NET Core satellite**Related ADR:** [ADR-0063: Idempotency Middleware](../../adrs/0063-idempotency-middleware.md)
