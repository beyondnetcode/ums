...
- **[Database Design ER](./blueprints/database-design-er.md)**: The authoritative physical entity-relationship model.
- **[Data Model Consistency Review](./blueprints/data-model-consistency-review.md)**: Cross-check between conceptual model, DDD aggregates, ER diagrams, and EF Core persistence records.
...
- **[Domain Aggregate Index](../domain/index.md)**: Authoritative aggregate-root catalog.
