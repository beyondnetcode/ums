 ...
 *
 * Accepts an item, icon, title, subtitle, and field definitions.
 * Renders a styled M3Card with customizable content areas.
 * Replaces duplicate card markup across list panels.
 */
