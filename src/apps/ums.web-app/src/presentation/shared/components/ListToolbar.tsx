      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-m3-outline/10">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="inline-flex items-center justify-center w-7 h-7 rounded-md bg-m3-surface border border-m3-outline/30 text-m3-secondary hover:text-m3-primary hover:border-m3-primary/40 hover:bg-m3-primary/5 transition-all"
