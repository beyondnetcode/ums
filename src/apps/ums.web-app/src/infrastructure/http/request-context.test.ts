...
import { configureRequestContext, getRequestContext, BASE_URL, DEV_TENANT_ID } from './request-context';
...
describe('request-context', () => {
  ...
  it('exports DEV_TENANT_ID', () => {
    expect(DEV_TENANT_ID).toBe('3fa85f64-5717-4562-b3fc-2c963f66afa6');
  });
