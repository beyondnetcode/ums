...
export function isReadAction(actionCode: string): boolean {
  ...
  return upper === 'VIEW' || upper === 'LIST' || upper === 'READ' || upper.endsWith('_VIEW') || upper.endsWith('_LIST');
}
 ...
 */
export function getSiblingViewOptions(suite: SystemSuite, optionId: string): { id: string, type: 'Option' }[] {
