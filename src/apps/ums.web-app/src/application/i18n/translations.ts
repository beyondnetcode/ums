...
const translations = {
  es: {
    ...
    tenantCodeInvalidFormat: 'El código solo puede contener letras mayúsculas, números y guiones bajos.',
    tenantCreateFailed: 'No se pudo crear el tenant. Intente nuevamente.',
    ...
    branchCreateFailed: 'No se pudo crear la sucursal. Intente nuevamente.',
    ...
    notifBrandingFailed: 'URL de Logo Inválida',
    notifBrandingFailedMsg: 'La URL del logo debe ser una dirección pública válida (http/https).',
    ...
    notifStatusChangeFailedMsg: (status: string) => `No se pudo actualizar el estado del tenant a ${status}.`,
  },
  ...
  en: {
    ...
    tenantCodeInvalidFormat: 'Code can only contain uppercase letters, numbers, and underscores.',
    tenantCreateFailed: 'Failed to create tenant. Please try again.',
    ...
    branchCreateFailed: 'Failed to create branch. Please try again.',
    ...
    notifBrandingFailed: 'Invalid Logo URL',
    notifBrandingFailedMsg: 'Logo URL must be a valid public address (http/https).',
    ...
    notifStatusChangeFailedMsg: (status: string) => `Could not update tenant status to ${status}.`,
