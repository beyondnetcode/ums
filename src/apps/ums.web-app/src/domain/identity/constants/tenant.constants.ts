...
export const DEV_TENANTS: DevTenant[] = [
  ...
  { id: '9e8d7c6b-5a4f-3e2d-1c0b-9876543210fe', code: 'PAITA_PORT',    name: 'Terminal Portuario de Paita S.A.' },
  { id: '5f4e3d2c-1b0a-9f8e-7d6c-543210987654', code: 'UNIMAR',        name: 'Unimar S.A. — Lima' },
  { id: 'f3e2d1c0-b9a8-7f6e-5d4c-321098765432', code: 'INTRADEVCO',    name: 'Intradevco Industrial S.A.' },
];
