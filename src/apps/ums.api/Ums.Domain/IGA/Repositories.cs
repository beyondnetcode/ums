...
public interface IPromotionRequestRepository : IAggregateRepository<PromotionRequestAggregate>
{
    ...
    Task<IReadOnlyList<PromotionRequestAggregate>> GetAllAsync(CancellationToken cancellationToken = default);
...
public interface IRoleMaturityStatusRepository : IAggregateRepository<RoleMaturityStatusAggregate>
{
    ...
    Task<IReadOnlyList<RoleMaturityStatusAggregate>> GetAllAsync(CancellationToken cancellationToken = default);
