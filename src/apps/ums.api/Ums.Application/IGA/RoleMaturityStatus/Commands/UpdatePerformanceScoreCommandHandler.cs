...
public sealed class UpdatePerformanceScoreCommandHandler
    : ICommandHandler<UpdatePerformanceScoreCommand>
{
    private readonly IRoleMaturityStatusRepository _repository;
    private readonly IUserContext _userContext;

    public UpdatePerformanceScoreCommandHandler(
    ...
    public async Task<Result> Handle(
        UpdatePerformanceScoreCommand request,
        CancellationToken cancellationToken)
    {
        ...
        var result = entity.UpdatePerformanceScore(request.Score, ActorId.Create(_userContext.UserId));
