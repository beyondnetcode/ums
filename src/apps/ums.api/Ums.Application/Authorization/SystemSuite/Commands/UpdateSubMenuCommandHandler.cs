...
public sealed class UpdateSubMenuCommandHandler : ICommandHandler<UpdateSubMenuCommand>
{
    private readonly ISystemSuiteRepository _repository;
    private readonly IUserContext _userContext;

    public UpdateSubMenuCommandHandler(ISystemSuiteRepository repository, IUserContext userContext)
    {
    ...
    public async Task<Result> Handle(UpdateSubMenuCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = suite.UpdateSubMenu(
