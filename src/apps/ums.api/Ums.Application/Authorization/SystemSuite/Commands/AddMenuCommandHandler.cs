...
public sealed class AddMenuCommandHandler : ICommandHandler<AddMenuCommand>
{
    private readonly ISystemSuiteRepository _repository;
    private readonly IUserContext _userContext;

    public AddMenuCommandHandler(ISystemSuiteRepository repository, IUserContext userContext)
    {
