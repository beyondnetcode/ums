...
public sealed class UpdateMenuCommandHandler : ICommandHandler<UpdateMenuCommand>
{
    private readonly ISystemSuiteRepository _repository;
    private readonly IUserContext _userContext;

    public UpdateMenuCommandHandler(ISystemSuiteRepository repository, IUserContext userContext)
    {
