...
public sealed class RemoveSubMenuCommandHandler : ICommandHandler<RemoveSubMenuCommand>
{
    private readonly ISystemSuiteRepository _repository;
    private readonly IUserContext _userContext;

    public RemoveSubMenuCommandHandler(ISystemSuiteRepository repository, IUserContext userContext)
    {
    ...
    public async Task<Result> Handle(RemoveSubMenuCommand request, CancellationToken cancellationToken)
    {
        ...
        var result = suite.RemoveSubMenu(
