...
public sealed class ActivatePasswordCommandHandler : ICommandHandler<ActivatePasswordCommand>
{
    private readonly IUserAccountRepository _userAccountRepository;
    private readonly IUserContext _userContext;

    public ActivatePasswordCommandHandler(
    ...
    public async Task<Result> Handle(ActivatePasswordCommand request, CancellationToken cancellationToken)
    {
