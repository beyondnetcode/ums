...
public sealed class RemoveUserAccountPasswordCommandHandler : ICommandHandler<RemoveUserAccountPasswordCommand>
{
    private readonly IUserAccountRepository _userAccountRepository;
    private readonly IUserContext _userContext;

    public RemoveUserAccountPasswordCommandHandler(IUserAccountRepository userAccountRepository, IUserContext userContext)
    {
    ...
    public async Task<Result> Handle(RemoveUserAccountPasswordCommand request, CancellationToken cancellationToken)
    {
