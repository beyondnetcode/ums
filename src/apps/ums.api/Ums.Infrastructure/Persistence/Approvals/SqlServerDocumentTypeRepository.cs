...
public sealed class SqlServerDocumentTypeRepository : IDocumentTypeRepository, IUnitOfWork
{
    private readonly UmsPlatformDbContext _dbContext;
    private readonly HashSet<DocumentTypeAggregate> _trackedAggregates = [];

    public SqlServerDocumentTypeRepository(UmsPlatformDbContext dbContext)
    {
