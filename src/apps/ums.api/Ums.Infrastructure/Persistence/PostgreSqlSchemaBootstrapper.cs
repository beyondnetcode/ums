...
public static partial class PostgreSqlSchemaBootstrapper
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var assembly = typeof(PostgreSqlSchemaBootstrapper).Assembly;

            // In PostgreSQL, EF Core Migrations and OnModelCreating fully define the schemas and tables,
            // so we do not execute the SQL Server-specific .sql scripts.
        }
        finally
        {
