...
public sealed class SqlServerTenantParameterRepository : ITenantParameterRepository, IUnitOfWork
{
    private readonly UmsPlatformDbContext dbContext;
    private readonly HashSet<TenantParameterAggregate> _trackedAggregates = [];

    public SqlServerTenantParameterRepository(UmsPlatformDbContext dbContext)
    {
