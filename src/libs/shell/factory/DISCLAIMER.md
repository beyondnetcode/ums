...
This project (`Ums.Shell.Factory`) includes initial code that was originally authored by **raulnq** and made available at [https://github.com/raulnq](https://github.com/raulnq).
